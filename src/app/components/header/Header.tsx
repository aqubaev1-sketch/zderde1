              ...
              {!loading && (
                user ? (
                  ...
                  <>
                    ...
                    <Link href="/register" className="w-full max-w-[260px] py-3 text-center text-[14px] font-bold uppercase text-white bg-[#1b1b1b] rounded-[4px]" onClick={closeMenu}>
                      Регистрация
                    </Link>
                  </>
                )
              ...
              <div className="flex items-center gap-[15px]">
                {user ? (
                  <>
                    ...
                    <button
                      onClick={handleLogout}
                      className="text-[14px] font-bold uppercase text-[#6a7282] bg-transparent hover:text-[#1f1f1f] hover:bg-[#e9e7e7] transition-all px-[18px] py-[10px] rounded-[4px]"
                    >
                      Выйти
                    </button>
                  </>
                  ...
                  <>
                    ...
                    <Link href="/register" className="inline-flex items-center justify-center px-[18px] py-[10px] tracking-[1px] text-[14px] font-bold uppercase bg-[#1b1b1b] text-white rounded-[4px] hover:opacity-85 transition-opacity font-['Inter',sans-serif]">
                      Регистрация
                    </Link>
                  </>
                )}
