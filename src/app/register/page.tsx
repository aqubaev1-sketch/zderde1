      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            ...
            className="mt-2 w-full rounded-[4px] bg-[#1b1b1b] text-white text-[14px] font-bold uppercase tracking-[1px] py-3 hover:opacity-85 transition-opacity disabled:opacity-50"
          >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-[4px] border border-[#d1d5db] py-3 text-[14px] font-bold uppercase tracking-[1px] text-[#1b1b1b] hover:bg-[#f5f5f5] transition-colors disabled:opacity-50"
        >
          <GoogleIcon />
